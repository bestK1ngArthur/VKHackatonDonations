//
//  RegularDonationViewController.swift
...
class RegularDonationViewController: UIViewController {
...
extension RegularDonationViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "addPhoto") as? AddPhotoTableViewCell, indexPath.row == 0 {
            ...
            if let cell = tableView.dequeueReusableCell(withIdentifier: "textFiled") as? TextFieldTableViewCell {
                switch indexPath.row {
                case 1:
                    cell.titleLabel.text = "Название сбора"
                    cell.textView.text = "Название сбора"
                case 2:
                    cell.titleLabel.text = "Сумма в месяц, ₽"
                    cell.textView.text = "Сколько нужно в месяц"
                case 3:
                    cell.titleLabel.text = "Цель"
                    cell.textView.text = "Например, поддерджка приюта"
                case 4:
...
extension RegularDonationViewController: UITableViewDelegate {
